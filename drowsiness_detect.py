...
dist = scipy.spatial.distance.euclidean(minimal, maximal)
dists = scipy.spatial.distance.seuclidean(minimal, maximal, variances)
...
EYE_ASPECT_RATIO_THRESHOLD = 0.20 #0.3

#Minimum consecutive frames for which eye ratio is below threshold for alarm to be triggered
EYE_ASPECT_RATIO_CONSEC_FRAMES = 5 #50
